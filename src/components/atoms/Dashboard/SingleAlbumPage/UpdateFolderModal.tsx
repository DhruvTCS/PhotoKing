// src/components/UpdateFolderModal.tsx
...
const UpdateFolderModal: React.FC<UpdateFolderModalProps> = ({ isOpen, onRequestClose, currentFolder }) => {
    ...
    return (
        <ModalOverlay>
            <ModalContent>
                            ...
                            {currentFolder.images.map((image, index) =>
                                <ImagePreview key={index}>
                                    ...
                                    <SelectedIconContainer>
                                        <SelectedIcon src={SelectedIconPNG} />
                                    </SelectedIconContainer>
                                </ImagePreview>)}
                ...
                <ButtonContainer>
                    <SubmitButton text={'Update'} width={90} height={40} needArrow={false} onClick={() => handleCreateFolder()} active={!(newFolderImages.length > 0)} />
